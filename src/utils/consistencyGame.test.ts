...
function makeDay(overrides: Partial<ChartDayEntry> = {}): ChartDayEntry {
  return {
    ...
    weightAvg: 168,
    attributes: {
      vitality:   { level: 1, currentLvlXp: 10, nextLvlXp: 100, totalXp: 10 },
      discipline: { level: 1, currentLvlXp: 10, nextLvlXp: 100, totalXp: 10 },
      strength:   { level: 1, currentLvlXp: 10, nextLvlXp: 100, totalXp: 10 },
